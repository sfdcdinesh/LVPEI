({
    ...
    Submit: function(component, event, helper) {  
        ...
        console.log("blood data size "+bloodData.length);
        var colloidData = component.get("v.colloidList");
        console.log("colloidData data size "+colloidData.length);
        var crystalloidData = component.get("v.crystalloidList");
        console.log("crystalloidData data size "+crystalloidData.length);
